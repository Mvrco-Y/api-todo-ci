...
[![Deploy Multi-Env](https://github.com/Mvrco-Y/api-todo-ci/actions/workflows/deploy-multi-env.yml/badge.svg)](https://github.com/Mvrco-Y/api-todo-ci/actions/workflows/deploy-multi-env.yml)
![Version](https://img.shields.io/github/v/tag/Mvrco-Y/api-todo-ci?label=version)
...
|---------------|-----|---------|--------|
| **Production** | [api-todo-PRENOM-prod.onrender.com](https://api-todo-ci-jeanmarc.onrender.com) | `main` | Actif |
| **Staging** | [api-todo-PRENOM-staging.onrender.com](https://api-todo-ci-jeanmarc.onrender.com) | `develop` | Actif |
---
...
|---------|-------|-------------|---------|
| GET | `/` | Infos de l'API | `curl https://api-todo-ci-jeanmarc.onrender.com/` |
| GET | `/todos` | Liste tous les todos | `curl https://api-todo-ci-jeanmarc.onrender.com/todos` |
| GET | `/todos/:id` | Un todo spécifique | `curl https://api-todo-ci-jeanmarc.onrender.com/todos/1` |
...
| GET | `/health` | Health check | `curl https://api-todo-ci-jeanmarc.onrender.com/health` |
---
## Tests
```bash
...
git clone https://github.com/Mvrco-Y/api-todo-ci.git
cd api-todo-ci
# Installer les dépendances
npm install
...
- Render.com
### Auteur
**Votre Prénom Nom** - [GitHub](https://github.com/VOTRE-USERNAME)
---
## Ressources
